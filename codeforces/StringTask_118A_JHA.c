...
int main()
{
	...
	printf("After removing vowels, String Length = %d\n",n);
	printf("And string is now:\n");
	...
	printf("After *smalling* string:  String Length is %d\n",n);
	printf("And string is now:\n");
	...
	printf("After putting a '.' before every consonant: String Length is %d\n",n);
	printf("And string is now: \n");
